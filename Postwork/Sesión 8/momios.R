...
#RawData <- "C:\\\"
#lista <- list(u1011, u1112, u1213, u1314, u1415, u1516, u1617, u1718, u1920)
...
d1011 <- read.csv(u1011)
d1112 <- read.csv(u1112)
d1213 <- read.csv(u1213)
d1314 <- read.csv(u1314)
d1415 <- read.csv(u1415)
d1516 <- read.csv(u1516)
d1617 <- read.csv(u1617)
d1718 <- read.csv(u1718)
d1819 <- read.csv(u1819)
d1920 <- read.csv(u1920)
